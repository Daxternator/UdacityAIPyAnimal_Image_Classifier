...
def print_results(results_dic, results_stats_dic, model, 
    ...
    print("{:20}: {:2.2f}".format('Correct Dog', results_stats_dic['pct_correct_dogs']))
    print("{:20}: {:2.2f}".format('Correct Breed', results_stats_dic['pct_correct_breed']))
    print("{:20}: {:2.2f}".format('Correct Not-a Dog', results_stats_dic['pct_correct_notdogs']))
    print("{:20}: {:2.2f}".format('Match', results_stats_dic['pct_match']))
